    ...
    <form action="{{ route('sisw.update',$sisw->id) }}" method="POST">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>name:</strong>
                <input type="text" name="name" class="form-control" placeholder="name SISWA" value="{{ $sisw->name }}">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>umur:</strong>
                <input class="form-control" name="umur" placeholder="Content" value="{{ $sisw->umur }}">
            </div>
        </div>
